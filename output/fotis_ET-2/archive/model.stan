/* fotis.stan
- an implementation of the f(Q) model found in arXiv:2104.15123 to be constrained using standard sirens
- note: the ' following the arrays is the transponse operator to transform it into a column vector since [] denotes row vectors
*/
...
parameters {
  real<lower=0> h;
  real Omega_m;
  real<upper=1.21306131942526684721-Omega_m> Omega_r;  // constrain such that Ωm + Ωr ≤ 2e^(-0.5)
}
